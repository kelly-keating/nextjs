  ...
  return (
    <footer>
      <div className="social_list">
        <a href="https://github.com/kelly-keating">
          <svg
            role="img"
          ...
          >
            ...
            <g>
              <path fill="white" d={paths.github.icon} />
            </g>
          </svg>
        </a>
        <a href="https://linkedin.com/in/kelly-keating-nz/">
          <svg
            role="img"
          ...
          >
            ...
            <g>
              <path fill="white" d={paths.linkedin.icon} />
            </g>
          </svg>
        </a>
      </div>
