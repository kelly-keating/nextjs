...
export const projects: Project[] = [
  ...
  { id: 'easy-budget', name: 'easy-budget', image: 'easy-budget_breakdown.png',
    blurb: 'We currently rely on banks to create integrated tools to help us track our budgets or use free tools that are often just glorified spreadsheets without the helpful tooling. I created this tool to help make parsing my csv files easier and to see where my money disappears off to :P',
    details: '',
    tech: [
      tech[1],
      tech[11],
  ...
  { id: 'retro-neon-grid-react', name: 'Retro Grid Node Module', image: 'retro_grid_npm.png',
    blurb: ' A node module I created and deployed to npm. Creates a sweet customisable grid for your react project in the style of Tron\'s Grid.',
    details: '',
    tech: [
      tech[1],
      tech[13],
  ...
  { id: 'magic-awaaaay', name: 'MTG Card Library', image: 'magic-away_home.png',
    blurb: 'Keep track of your card collection, set completion, and the prices of cards.',
    details: '',
    tech: [
      tech[0],
      tech[1],
  ...
  { id: 'curriculum', name: 'curriculum', image: 'ts_kata.png',
    blurb: 'Tools I contributed to or created to help students learning web development.',
    details: '',
    tech: [
      tech[0],
      tech[1],
  ...
  { id: 'this-site', name: 'kelly-keating.com', image: 'kelly-keating_home.png',
